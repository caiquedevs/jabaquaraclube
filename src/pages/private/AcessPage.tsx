        ...
        <section style={{ maxWidth: '1016px' }} className="w-full h-full mx-auto">
          <div className="w-full flex items-center justify-between pt-10 pb-7">
            <div className="flex items-center">
              ...
              <h1 className="font-changa font-semibold text-4xl text-black/70">Acessos</h1>
            </div>
          ...
          <div className="flex gap-7">
            <button type="button" className="px-2 pb-2 border-b-2 border-primary">
              <span className="font-semibold text-black/70 text-sm">Todos acessos</span>
            </button>
          </div>
        </section>
      </header>
          ...
          {users?.map((user) => {
            return (
              <li key={user._id} className="box bg-white rounded-lg">
                ...
                <div className="pt-11 pb-8 flex justify-center">
                  <img src="/default-user.jpg" alt="user photo" className="w-16 h-16 rounded-lg" />
                </div>

                <div className="pl-7 pb-7 flex flex-col">
