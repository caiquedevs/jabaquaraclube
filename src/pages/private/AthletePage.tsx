...
import { Button, Drawer, ShowIf } from 'components';
          ...
          return (
            <>
              <section className="w-full px-5">
                <div className="w-full px-10 py-8 flex items-center justify-between bg-sky-50 rounded-xl">
                  <figure className="flex items-center gap-10">
                    <img
                      src={import.meta.env.VITE_API_URL + '/photos/' + athlete?.uri}
                      alt="foto do atléta"
                      className={`w-14 h-14 rounded-full ${athlete?.uri ? 'block' : 'hidden'}`}
                    />

                    <FaUserCircle className={`text-[56px] text-slate-400 ${athlete?.uri ? 'hidden' : 'block'}`} />
                  ...
                  <div className="flex items-center gap-2">
                    <Button type="button" className="w-12 h-12 px-0 py-0 bg-transparent fill-slate-400 hover:fill-red-500">
                      <svg
                        width="25"
                        height="25"
                        viewBox="0 0 30 30"
                    ...
                    <Button type="button" className="w-11 h-11 px-0 py-0 rounded-full bg-primary">
              ...
              <section className="w-full px-5 mt-4 flex">
              ...
              <ShowIf as="section" show={athlete?.certificateValidity.file} className="w-full px-5 mt-8">
                <h2 className="font-normal text-base text-primary">Atestado médico</h2>

                <div className="mt-4 flex items-center gap-4">
                  <div className="w-12 h-12 flex items-center justify-center rounded-lg bg-primary font-bold text-white text-xs">
                    DOC
                  </div>

                  <div>
                    <strong className="mb-2 font-semibold text-base text-back/80">Validade</strong>
                    <small className="text-base text-black/70">{athlete?.certificateValidity.date}</small>
                  </div>
                </div>
              </ShowIf>
